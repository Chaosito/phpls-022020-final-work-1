          ...
          <div class="container">
            <header class="header">
              ...
              <div class="header__links">
                  <a class="order-link btn" href="#link-lets-order">Заказать</a>
              ...
              <ul class="burgers-slider owl-carousel">
                <li class="burgers-slider__item">
                  ...
                  <div class="burgers-slider__left">
                      <img class="burgers-slider__pic" src="./img/content/burgers/1.png" alt="">
                  </div>
                ...
                <li class="burgers-slider__item">
                  ...
                  <div class="burgers-slider__left">
                      <img class="burgers-slider__pic" src="./img/content/burgers/2.png" alt="">
                  </div>
                  <div class="burgers-slider__right">
                    <div class="section__title section__title_white">Dark Beef Burger</div>
                      <div class="burgers-slider__text text-block">
                ...
                <li class="burgers-slider__item">
                  ...
                  <div class="burgers-slider__left">
                      <img class="burgers-slider__pic" src="./img/content/burgers/3.png" alt="">
                  </div>
                  <div class="burgers-slider__right">
                    <div class="section__title section__title_white">Dark Beef Burger</div>
                      <div class="burgers-slider__text text-block">
                ...
                <li class="burgers-slider__item">
                  ...
                  <div class="burgers-slider__left">
                      <img class="burgers-slider__pic" src="./img/content/burgers/4.png" alt="">
                  </div>
                  <div class="burgers-slider__right">
                    <div class="section__title section__title_white">Dark Beef Burger</div>
                      <div class="burgers-slider__text text-block">
            ...
            <li class="reviews__item">
              <div class="review">
                ...
                <div class="review__hover">
                  ...
                  <div class="review__shorttext">
                      Мысли все о них и о них, о них и о них. Нельзя устоять, невозможно забыть... Никогда не думал,
                      что булочки могут быть такими мягкими, котлетка такой сочной, а сыр таким расплавленным.
                  </div>
                ...
                <div class="order__form-col">
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" name="name" type="text"
                             value="<?=$curUser->firstName;?>" required>
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Телефон</div>
                      <input class="order__form-input phone-mask" name="phone"
                             value="<?=$curUser->phone;?>" type="text" required>
                    </label>
                  </div>
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      <div class="order__form-label">email</div>
                      <input class="order__form-input" name="email" type="email" value="<?=$curUser->mail;?>" required>
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Улица</div>
                      <input class="order__form-input" name="street" type="text"
                             value="<?=$curUser->street;?>" required>
                    </label>
                  </div>
                  <div class="order__form-row order__form-row_quatro">
                    <label class="order__form-block">
                      <div class="order__form-label">Дом</div>
                      <input class="order__form-input" name="home" type="text" value="<?=$curUser->house;?>" required>
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Корпус</div>
                      <input class="order__form-input" name="part" type="text" value="<?=$curUser->building;?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Квартира</div>
                      <input class="order__form-input" name="appt" type="text" value="<?=$curUser->apartment;?>">
                    </label>
                    <label class="order__form-block">
                      <div class="order__form-label">Этаж</div>
                      <input class="order__form-input" name="floor" type="text" value="<?=$curUser->floor;?>">
                    </label>
                  </div>
                </div>
                <div class="order__form-col">
                  ...
                  <div class="order__form-buttons">
                    ...
                    <div class="order__form-row">
                      ...
                      <a href="try-order.php?logout" class="order__form-button order__form-button_reset"
      ...
      <div class="full-review__inner">
        ...
        <div class="full-review__content">
          Мысли все о них и о них, о них и о них. Нельзя устоять, невозможно забыть...
            ...
            могут быть такими мягкими, котлетка такой сочной, а сыр таким расплавленным.
        </div>
      </div>
    </div>
